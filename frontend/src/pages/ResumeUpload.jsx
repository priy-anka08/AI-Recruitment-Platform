...
const ResumeUpload = () => {
  ...
  const getScoreColor = (score) => {
    if (score >= 70) return { bg: '#c6f6d5', color: '#276749' };
    if (score >= 50) return { bg: '#fefcbf', color: '#744210' };
      ...
      <div style={{ marginLeft: '250px', flex: 1, padding: '32px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
            ...
            <form onSubmit={handleUpload}>
              ...
              <div style={{ marginBottom: '24px' }}>
                ...
                <div style={{
                  ...
                  background: '#f7f8ff', cursor: 'pointer',
                }}>
                  ...
                  <label
                    htmlFor="fileInput"
                    style={{
                      padding: '8px 20px', background: '#667eea',
            ...
            {result && (
              <div style={{
                ...
                <div style={{ display: 'grid', gap: '10px' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <span style={{ color: '#666', fontSize: '13px' }}>💼 Experience</span>
                    <span style={{ fontWeight: '600', fontSize: '13px', color: '#333' }}>
                  ...
                  {result.skills && (
                    <div>
                      <span style={{ color: '#666', fontSize: '13px' }}>🛠️ Skills</span>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '4px' }}>
                    ...
                    <span style={{
                      padding: '4px 14px',
                      background: getScoreColor(result.ats_score).bg,
                      color: getScoreColor(result.ats_score).color,
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <span style={{ color: '#666', fontSize: '13px' }}>📋 Recommendation</span>
                    <span style={{
                      padding: '4px 14px',
                      ...
                      {result.ats_score >= 70 ? '✅ Selected' : '❌ Rejected'}
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div style={{
            ...
            padding: '28px', boxShadow: '0 4px 15px rgba(0,0,0,0.06)',
          }}>
            <h3 style={{ margin: '0 0 20px', color: '#1e3a5f', fontSize: '16px' }}>
              🏆 Candidate Rankings
            </h3>
                ...
                {candidates.map((c, i) => (
                  <div key={c.id} style={{
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      {c.skills && (
                        <p style={{ margin: 0, fontSize: '11px', color: '#667eea', fontWeight: '600' }}>
                          🛠️ {c.skills.split(',').slice(0, 3).join(', ')}
                    ...
                    <div style={{
                      padding: '4px 12px',
                      background: getScoreColor(c.ats_score).bg,
                      color: getScoreColor(c.ats_score).color,
                      borderRadius: '20px', fontWeight: '700', fontSize: '13px',
                    }}>
                      {c.ats_score}%
                    </div>
